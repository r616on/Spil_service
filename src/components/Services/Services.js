    ...
    if (typeof element === "string") {
      ...
      this.arr = [
        ...
        },
        {
          ...
          src: crowning,
          text: "Оказываем услуги по кронированию деревьев.\n\n Для оценки Вашего объекта звоните по телефону или пишите в WhatsApp",
        },
        {
          id: 3,
          title: "Обрезка кустарников",
          src: obrezka,
          text: "Оказываем услугами по обрезке кустарников.\n\n Для оценки Вашего объекта звоните по телефону или пишите в WhatsApp",
        },
        {
          id: 4,
          title: "Вывоз порубочных остатков",
          src: exportD,
          text: "Вывоз порубочных остатков после спила или валки дерева.\n\n Для оценки Вашего объекта звоните по телефону или пишите в WhatsApp",
        },
      ];
